...
from dataset_utils_clip import create_dataset, BalancedSampler
...
train_dataset, test_dataset = create_dataset(path, preprocess, clip.tokenize, test_idx=test_idx)
...
sampler = BalancedSampler(training_set)
trainloader = DataLoader(training_set, batch_size=batch_size, sampler=sampler)

sampler = BalancedSampler(validation_set)
valloader = DataLoader(training_set, batch_size=batch_size, sampler=sampler)


sampler = BalancedSampler(test_dataset)
testloader = DataLoader(test_dataset, batch_size=batch_size, sampler=sampler)
...
net = openSetClip.openSetClassifier(cfg['num_known_classes'], cfg['im_channels'], cfg['im_size'], device = device)
